...
The files in the main directory named [Final_Analysis.Rmd](https://github.com/DenefLab/Diversity_Productivity/blob/master/Final_Analysis.Rmd), [Final_Analysis.html](Final_Analysis.html), and [Final_Figures/](https://github.com/DenefLab/Diversity_Productivity/tree/master/Final_Figures) folder have all of the final analysis contents. **Please note that the [Final_Figures/](https://github.com/DenefLab/Diversity_Productivity/tree/master/Final_Figures) folder has all of the figures in the manuscript except Figure S6, which can be found [here](https://github.com/DenefLab/Diversity_Productivity/blob/master/analysis/OTU_Removal_Analysis_Figs/figS6-1.png).**
